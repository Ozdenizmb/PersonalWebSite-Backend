...
public interface LikeApi {
    ...
    @Operation(operationId = "addLike", summary = "Add like.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Boolean.class))),
            @ApiResponse(responseCode = "201", description = "Created", content = @Content(schema = @Schema(implementation = LikeCreateDto.class))),
    ...
    ResponseEntity<Integer> getLikeCount(@PathVariable UUID projectId);

    @Operation(operationId = "didILikeIt", summary = "Did I like it?")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Boolean.class))),
            @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content(schema = @Schema(implementation = Error.class))),
    ...
    @GetMapping(value = "/didILikeIt", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<Boolean> didILikeIt(@RequestParam UUID userId, @RequestParam UUID projectId);

    @Operation(operationId = "deleteLike", summary = "Delete like.")
    ...
    ResponseEntity<Boolean> deleteLike(@RequestParam UUID userId, @RequestParam UUID projectId);
