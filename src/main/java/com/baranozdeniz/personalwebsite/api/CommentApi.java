...
public interface CommentApi {
    ...
    @Operation(operationId = "createComment", summary = "Create comment.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Boolean.class))),
            @ApiResponse(responseCode = "201", description = "Created", content = @Content(schema = @Schema(implementation = CommentCreateDto.class))),
    ...
    ResponseEntity<CommentDto> createComment(@RequestBody @Valid CommentCreateDto commentCreateDto);

    @Operation(operationId = "getComment", summary = "Get comment.")
    ...
    @Operation(operationId = "getCommentsWithProject", summary = "Get comments with project.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = CommentDto.class))),
            @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content(schema = @Schema(implementation = Error.class))),
    ...
    ResponseEntity<CommentDto> updateComment(@PathVariable UUID id, @RequestBody @Valid CommentUpdateDto commentUpdateDto);

    @Operation(operationId = "deleteComment", summary = "Delete comment.")
    ...
    ResponseEntity<Boolean> deleteComment(@PathVariable UUID id);
